...
│                                                                              │
│  ┌─────────────────────────────────┐   ┌─────────────────────────────────┐  │
│  │  🔍 Requirement Analyst         │   │  🗺️ Codebase Scout               │  │
│  │  ├─ Parse requirement           │   │  ├─ Find related files          │  │
│  │  ├─ Define scope/criteria       │ ⚡ │  ├─ Analyze dependencies        │  │
│  │  ├─ List unknowns               │   │  ├─ Identify patterns           │  │
│  │  └─ Output: requirements.md     │   │  └─ Output: codebase-analysis   │  │
│  └─────────────────────────────────┘   └─────────────────────────────────┘  │
│                          │                           │                       │
│                          └───────────┬───────────────┘                       │
│                                      ▼                                       │
